...
ggsave(file.path("Figures", "Chapter-3", "fig-3-1-a.pdf"), plot = p_plot_a, width = 5, height = 5)
ggsave(file.path("Figures", "Chapter-3", "fig-3-1-b.pdf"), plot = p_plot_b, width = 5, height = 5)
