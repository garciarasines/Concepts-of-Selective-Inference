...
ggsave(file.path("Figures", "Chapter-6", "fig-6-4-a.pdf"), plot = p_plot_a, width = 5, height = 5)
ggsave(file.path("Figures", "Chapter-6", "fig-6-4-b.pdf"), plot = p_plot_b, width = 5, height = 5)
